...
bool	send16,send17, send18, send19, send40, send41, send48, send49, send92, send50;		// message triggers
...
pinMode(ACT3, OUTPUT);          // set actuator 1
ACT3State = 0;
digitalWrite(ACT3, ACT3State);

pinMode(ACT4, OUTPUT);          // set actuator 1
ACT4State = 0;
