// NOD 99 SENZOR  DIMA  ZETA

// pin 4 - Aktivacija senzora dima ( posle aktivacije mora da se resetuje ) 
// pin A3 - ULAZ ZA SENZOR DIMA
// pin 9 - IZLAZ ( ne koristi se )
...
//
#define NODEID 9 					// unique node ID within the closed network
...
#define PORUKA1 "NOD 9 SENZOR  DIMA"
...
#define ACT5 4            // Aktivacija senzora dima
...
unsigned long currentMillis1; //Tajmer za resetovanje senzora dima na 5 minuta ukoliko je vec detektovan dim 
unsigned long TIME1 = 150000;
bool A = 0;
...
pinMode(ACT5, OUTPUT);         
digitalWrite(ACT5, HIGH);           // Ukljucenje senzora DIMA
...
if ( digitalRead(BTN1)== 0 ) { //Tajmer za resetovanje senzora dima na 5 minuta ukoliko je vec detektovan dim 
     if (A == 0)  {           
                         currentMillis1 = millis(); 
                         A=1;            
                       }
     if (  millis() - currentMillis1 >= TIME1  )    {
